...
fn task_build() {
    ...
    cl::run_shell_command("rsync -a --delete-after pkg/ web_server_folder/new_date_time_units_and_formats/pkg/");
    println!(
        r#"
...
fn task_publish_to_web_server() {
    ...
    // rsync
    cl::run_shell_command("rsync -e ssh -a --info=progress2 --delete-after web_server_folder/new_date_time_units_and_formats/ luciano_bestia@bestia.dev:/var/www/bestia.dev/new_date_time_units_and_formats/");
